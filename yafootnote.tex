...
\newbox\vfillbox \setbox\vfillbox=\vbox{\vfill}
\def\yafootnotemark#1{\ensuremath{^{\mbox{#1}}}}
...
\directlua{%
    luatexbase.add_to_callback
      ("pre_output_filter",crush_footnotebox,"crushbox")}
